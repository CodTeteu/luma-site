        ...
        <div className="min-h-screen bg-cream selection:bg-olive-200 selection:text-olive-900">
            ...
            <header className="bg-white/80 backdrop-blur-md border-b border-olive-100 fixed w-full z-50">
                <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
                    <Link href="/preview/template1" className="flex items-center gap-2 text-olive-600 hover:text-olive-800 transition-colors uppercase tracking-widest text-xs font-medium">
                        <ArrowLeft size={16} />
                        Voltar ao Início
                    </Link>
